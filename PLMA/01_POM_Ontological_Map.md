...
- **`core/consciousness/quantum_thought.py`**: Aglutinador de multiversos. **Phase 48**: Implementação de Sovereign Ignition (Dampening bypass).
- **`core/consciousness/regime_detector.py`**: Visão macro-cibernética.
- **`core/decision/trinity_core.py`**: Veredicto final de Ação. **Phase 47**: Injeção de cooldowns de percepção e logging de PHI inteligente. **Phase 48**: Thresholds adaptativos para ignição (V-Pulse).
